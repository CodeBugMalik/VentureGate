...
export async function createConnectedSession(api: any): Promise<ConnectedSession> {
  ...
  // Set active network (Preview / Preprod)
  setNetworkId(config.networkId);

  // Serve compiled ZK keys & artifacts from the public directory (/managed)
  ...
  // Prove tx delegating to wallet proving provider
  const proofProvider = {
